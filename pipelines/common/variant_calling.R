...
#'        path must end with '/'
#' @return .vep files
vcf2vep <- function(vcfDir,outDir,bsub_fig = 'bsub -q short -W 4:00 -o ',vep = 'perl ~/ensembl-tools-release-85/scripts/variant_effect_predictor/variant_effect_predictor.pl'){

...
biocLite( c("ggplot2", "reshape", "gplots", "edgeR", "CHBUtils", "pheatmap",
...
The output consists of three files, each of them is an `n` by `p` matrix with `n` genes and `p` types of treatments:
